...
def problem_two(request):
    ...
    for instructor in instructors:
      ...
      print(f'Hired Date: {instructor.hire_date}')
...
def problem_five(request):
    student = Student.objects.create(first_name='Taylor', last_name='Britten', year=2022, gpa=3.0)
...
def problem_six(request):
    ...
    student_id = 12
    Student.objects.filter(pk=student_id).update(gpa=3.89)
